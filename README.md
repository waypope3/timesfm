...
> **Personal fork note:** I'm using this for experimenting with energy consumption forecasting on hourly meter data. The XReg covariate support added in Oct. 2025 is particularly useful for my use case.
