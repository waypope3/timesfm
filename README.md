...
> **Personal fork note:** I'm using this for experimenting with energy consumption forecasting on hourly meter data. The XReg covariate support added in Oct. 2025 is particularly useful for my use case. My typical setup uses a 720-hour (30-day) context window with a 24-hour forecast horizon.
...
4.  ✅ Fine-tuning example with LoRA via HuggingFace T